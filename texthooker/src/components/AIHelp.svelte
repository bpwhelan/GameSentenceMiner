...
<div class="ai-help">
	<button class="explain-toggle" aria-expanded={open} on:click={() => { open = !open; }}>Explain sentence</button>
	{#if open}
		<section aria-label="AI sentence help">
			<div class="controls">
				<select aria-label="Explanation type" bind:value={mode} disabled={busy}>
...
<style>
	...
	.explain-toggle { font-size: 12px; }
	section { border: 1px solid #666; border-radius: 7px; padding: 12px; margin-top: 7px; max-width: 850px; }
