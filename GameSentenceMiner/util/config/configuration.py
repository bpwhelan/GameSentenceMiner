...
class Screenshot:
    ...
    def __post_init__(self):
        ...
        if (
            not self.screenshot_timing_setting
            and not self.use_beginning_of_line_as_screenshot
            and not self.use_new_screenshot_logic
        ):
...
class Audio:
    ...
    def __post_init__(self):
        self.ffmpeg_reencode_options_to_use = self.ffmpeg_reencode_options.replace(
            "{format}", self.extension if self.extension in supported_formats else "mp3"
        ).replace(
            "{encoder}",
            supported_formats.get(self.extension, {"codec": "libmp3lame"})["codec"],
        )
...
class ProfileConfig:
    ...
    def load_from_toml(self, file_path: str):
        ...
        self.paths.folder_to_watch = sanitize_and_resolve_path(
            config_data["paths"].get("folder_to_watch", self.paths.folder_to_watch)
        )
...
class Config:
    ...
    def _migrate_anki_profile_data(profile_data: Dict[str, Any]) -> None:
        ...
        field_specs = {
            "sentence": {
                "legacy": "sentence_field",
                "default_name": "Sentence",
                "core": True,
                "legacy_overwrite": "overwrite_sentence",
                "default_overwrite": True,
            },
            "sentence_audio": {
                "legacy": "sentence_audio_field",
            ...
            "picture": {
                ...
                "default_name": "Picture",
                "core": True,
                "legacy_overwrite": "overwrite_picture",
                "default_overwrite": True,
            },
            "word": {
                "legacy": "word_field",
                "default_name": "Expression",
                "core": True,
                "legacy_overwrite": None,
                "default_overwrite": True,
            },
            "previous_sentence": {
                "legacy": "previous_sentence_field",
                "default_name": "",
                "core": False,
                "legacy_overwrite": None,
                "default_overwrite": False,
            ...
            "sentence_furigana": {
                "legacy": "sentence_furigana_field",
                "default_name": "SentenceFurigana",
                "core": False,
                "legacy_overwrite": None,
                "default_overwrite": True,
            },
            "game_name": {
                "legacy": "game_name_field",
                "default_name": "",
                "core": False,
                "legacy_overwrite": None,
                "default_overwrite": True,
