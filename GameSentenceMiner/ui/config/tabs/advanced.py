...
def build_advanced_tab(window: ConfigWindow, i18n: dict) -> QWidget:
    ...
    layout.addRow(
        window._create_labeled_widget(tabs_i18n, "advanced", "current_version"),
        window.current_version_label,
    )
    layout.addRow(
        window._create_labeled_widget(tabs_i18n, "advanced", "latest_version"),
        window.latest_version_label,
    )
