...
describe("Hoshidicts safe popup rendering", () => {
  ...
  it("normalizes and passes the configured Hoshidicts lookup mode", () => {
    ...
    expect(runOverlayFeatureBootstrap(true, "hover", "0").window
      .gsmHoshidictsPopupNestingMaxDepth).toBe(0);
    expect(runOverlayFeatureBootstrap(true, "hover", "invalid").window
      .gsmHoshidictsPopupNestingMaxDepth).toBe(10);

    const configured = runHoshidictsReaderConfiguration("hover", 4);
